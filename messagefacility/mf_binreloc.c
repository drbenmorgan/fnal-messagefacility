 ...
 * will be returned. If default_bin_dir is NULL, then NULL will be returned.
 */
char*
 ...
 * freed when no longer necessary. If BinReloc is not initialized, or if the
 *         initialization function failed, then a copy of default_locale_dir
 * will be returned. If default_locale_dir is NULL, then NULL will be returned.
 */
char*
 ...
 * initialization function failed, then a copy of default_lib_dir will be
 ...
 * when no longer necessary. If BinReloc is not initialized, or if the
 * initialization function failed, then a copy of default_libexec_dir will be
 * returned. If default_libexec_dir is NULL, then NULL will be returned.
 */
char*
 ...
 *         no longer necessary. If BinReloc is not initialized, or if the
 * initialization function failed, then a copy of default_etc_dir will be
 ...
 * @returns A newly-allocated string. This string should be freed when no longer
 * needed.
 */
char*
