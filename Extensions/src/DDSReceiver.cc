...
, tRecv             ( boost::bind(&DDSReceiver::run, this, mc, sc) )
{
...
void DDSReceiver::run(msgcall mc, syscall sc) {
...
void DDSReceiver::createDDSConnection() {
...
void DDSReceiver::destroyDDSConnection() {
